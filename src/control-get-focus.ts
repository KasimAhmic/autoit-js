 ...
 */
export function ControlGetFocusSync(windowTitle: string, windowText: string = ''): string {
 ...
 * @see https://www.autoitscript.com/autoit3/docs/functions/ControlGetFocus.htm
 */
export async function ControlGetFocus(windowTitle: string, windowText: string = ''): Promise<string> {
  const [buffer, length] = createUnicodeBuffer(1024);
